...
const WomenBorJ = ({ setCustomers, setTask }) => {
    ...
    return (
        ...
        <div className="container">
            ...
            <div className="flex">
                <input type="text" placeholder="L" name="lName" value={lname}
                    onChange={(e) => setLname(e.target.value)}
                    style={{ marginTop: "5px", marginBottom: "5px" }} />
                <div className="small text-center">{lVname}</div>
                <input type="text" placeholder="CHU" name="fname" value={fname}
                    onChange={(e) => setFname(e.target.value)}
                    style={{ marginTop: "5px", marginBottom: "5px", width:'160px' }} />
                <div className="small text-center">{fVname}</div>
            </div>
            <div className="flex">
                <input type="text" placeholder="U CHU" name="fname" value={fname}
                    onChange={(e) => setFname(e.target.value)}
                    style={{ marginTop: "5px", marginBottom: "5px", width:'170px' }} />
                <div className="small text-center">{fVname}</div>
                <input type="text" placeholder="HALF" name="lName" value={lname}
                    onChange={(e) => setLname(e.target.value)}
                    style={{ marginTop: "5px", marginBottom: "5px" }} />
                <div className="small text-center">{lVname}</div>
            </div>
            <div className="flex">
                <input type="text" placeholder="B" name="lName" value={lname}
                    ...
                    style={{ marginTop: "5px", marginBottom: "5px" }} />
                <div className="small text-center">{lVname}</div>
                <input type="text" placeholder="UW" name="fname" value={fname}
                    onChange={(e) => setFname(e.target.value)}
                    style={{ marginTop: "5px", marginBottom: "5px", width:'160px' }} />
                <div className="small text-center">{fVname}</div>
            </div>
            <div className="flex">
                <input type="text" placeholder="MW" name="fname" value={fname}
                    onChange={(e) => setFname(e.target.value)}
                    style={{ marginTop: "5px", marginBottom: "5px", width:'170px' }} />
                <div className="small text-center">{fVname}</div>
            ...
            <div className="flex">
                <input type="text" placeholder="SHOULDER" name="lName" value={lname}
                    onChange={(e) => setLname(e.target.value)}
                    style={{ marginTop: "5px", marginBottom: "5px" }} />
                <div className="small text-center">{lVname}</div>
                <input type="text" placeholder="BACK" name="fname" value={fname}
                    onChange={(e) => setFname(e.target.value)}
                    style={{ marginTop: "5px", marginBottom: "5px", width:'160px' }} />
                <div className="small text-center">{fVname}</div>
            </div>
            <div className="flex">
                <input type="text" placeholder="AMPITY" name="fname" value={fname}
                    onChange={(e) => setFname(e.target.value)}
                    style={{ marginTop: "5px", marginBottom: "5px", width:'170px' }} />
                <div className="small text-center">{fVname}</div>
                <input type="text" placeholder="LONG SLEEVES" name="lName" value={lname}
                    onChange={(e) => setLname(e.target.value)}
                    style={{ marginTop: "5px", marginBottom: "5px" }} />
                <div className="small text-center">{lVname}</div>
            </div>
