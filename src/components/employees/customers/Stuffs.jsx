                ...
                <div className="dash_grid_items">
                    ...
                    <div className=" container " style={{
                        ...
                        <div className="card_holder2" style={{
                            ...
                            <div className="common-grid-2 for_worker" style={{ "--grid-template": "auto", boxShadow: "10px 0px 10px 0px rgba(0, 0, 0, 0.1)", borderBottomLeftRadius: 0, borderBottomRightRadius: 0 }}
                                data-aos="fade-right" data-aos-duration="1000" >
